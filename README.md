...
In order to build the site iteratively the project is broken into phases. By in large, in each phase the project team presents a short cyle of work to real users so that their feedback can inform next steps.
